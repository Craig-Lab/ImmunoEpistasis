...
p.tau_I     = 0.1667;%0.01            % converted - eclipse phase

%Infected cell %------------------------------------
p.I0         = 0;               % Initial infected cells x 10^9
p.del_I_MPhi = 121.195;        % Rate macrophages phagocytose infected cells (1/day)
%p.del_I_T    = 50000;%40;            % Rate T cells clear infected cell (1/cell 1/day)
p.d_I	     = 0.144;            % lysis rate
%p.K_del_T    = 0.1;
p.K_del_T = 0.01;%1e-6;
p.K_del_T_var = p.K_del_T;%p.K_del_T*100;
p.del_I_T = 7;%238;%0.1;
p.del_I_T_var = p.del_I_T;%238;%0.1;
p.h_T = 0.5;
