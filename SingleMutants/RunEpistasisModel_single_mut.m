function [Healthy,Immunodeficiency] = RunEpistasisModel_single_mut(immune_effects,V10,V20,V30,V40,I10,I20,I30,I40,cGamma,mu_F,mu_I,mu_D,effects,prod_effects)
...
[time1,sol1,solstruc1] = model_rebound_single_mut_events(p,tspan,lambda,effects,prod_red);
time_deval = linspace(tspan(1),tspan(2),1e3);

sol1_deval = interp1(time1,sol1',time_deval);  
%extract_sx1 = interp1(time1,solstruc1.yp',time_deval);
...
[time2,sol2,solstruc2] = model_rebound_single_mut_events(p,tspan,lambda,effects,prod_red);
...
Immunodeficiency.time = time2;
Immunodeficiency.sol = sol2';